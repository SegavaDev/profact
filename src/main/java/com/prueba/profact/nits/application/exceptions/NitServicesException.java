 ...
 * Excepción para manejar los errores de persistencia
  */
public class NitServicesException extends Exception {

    /**
     * Lanza un mensaje personalizado 
     * @param mensaje
      */
    public NitServicesException(final String mensaje) {
        super(mensaje);
    }
     ...
     * @param codigo
      */
    public NitServicesException(final String mensaje, final Throwable codigo) {
