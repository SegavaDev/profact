 ...
 * Excepción para manejar los errores de servicios
  */
public class NoCreateFactException extends Exception {

    /**
     * Lanza un mensaje personalizado 
     * @param mensaje
      */
    public NoCreateFactException(final String mensaje) {
        super(mensaje);
    }
     ...
     * @param codigo
      */
    public NoCreateFactException(final String mensaje, final Throwable codigo) {
